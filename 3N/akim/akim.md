...
page->layout = "post";
page->title  = "AKIM";
page->description = "Akım Nasıl Akar";
page->date ="19/08/2025";
SET_POST();
---

**Anahtarlama:** Elektrik akımı, bir iletkenin kesitinden birim zamanda geçen net elektrik yükü miktarıdır. Birimi Amper'dir (A). Bir amper, bir saniyede geçen bir Coulomb'luk yüke eşittir.
<figure>
